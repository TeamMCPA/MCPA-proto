function [event_matrix] = MCP_get_subject_events(mcp, subject, channels, time_window, event_types)
...
oxy_timeser = mcp.fNIRs_time_series.Hb_data.Oxygenated(:, channels);
marks_vec = mcp.fNIRs_time_series.On_Sets_Marks_Matrix;
