function MCPA_struct = MCP_to_MCPA(mcp_multiple, data_file_array, incl_subjects, incl_channels, time_window)
...
event_types = 1:size(mcp_multiple(1).Experiment_data.Conditions.Condition_mark);
