...
%   data_file_array = {'alldata_WDIT_control2'};
%   data_file_array = data_file_array';
%   time_window = 0:100;
%   condition1 = 1;
%   condition2 = 2;
...
%   MCPA_output = output_MCPA_struct(data_file_array, incl_subjects, incl_channels, time_window);
% 
...
%   WDIT_trialleveldecoding_top3 = leave_one_Ss_out_classifyIndividualEvents(window_averages_struct,condition1,condition2);
...
% For single subject, single prob, and single run
    fprintf('Single Run Testing:\n')
    
    data_file_array{1} = {'Test_for_Joszef_001-RNAv3_MES_Probe1.nirs' 'Test_for_Joszef_002-BDZ_MES_Probe1.nirs' 'Test_for_Joszef_003-SZ_MES_Probe1.nirs' 'Test_for_Joszef_004-SGF_MES_Probe1.nirs' 'Test_for_Joszef_005-RRC_MES_Probe1.nirs'};
    data_file_array{2} = {'Test_for_Joszef_001-RNAv3_MES_Probe2.nirs' 'Test_for_Joszef_002-BDZ_MES_Probe2.nirs' 'Test_for_Joszef_003-SZ_MES_Probe2.nirs' 'Test_for_Joszef_004-SGF_MES_Probe2.nirs' 'Test_for_Joszef_005-RRC_MES_Probe2.nirs'};
    
    MCP_for_probs = MCP_for_multiple_probs(data_file_array, 1);
